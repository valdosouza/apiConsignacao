...
const Tb = db.restDough;
class RestDoughController extends Base {
  ...
  static getList(body) {
    const promise = new Promise((resolve, reject) => {
      Tb.sequelize.query(
        'SELECT rm.id, rm.description , "Massa" kind, price_tag '+
...
module.exports =  RestDoughController; 