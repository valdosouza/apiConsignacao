...
const Tb = db.restCalzone;
class RestCalzoneController extends Base {
  ...
  static update = (data) => {
    const promise = new Promise((resolve, reject) => {
      Tb.update(req.body, {
        ...
        .then(num => {
          if (num == 1) {
            resolve("RestCalzone foi atualizada com sucesso.");
          } else {
...
module.exports =  RestCalzoneController; 